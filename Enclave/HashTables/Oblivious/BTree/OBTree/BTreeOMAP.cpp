// See BTreeOMAP.h for what this class is for. Note search()/insert() call
// into BTree's "2" variants (search2/insert2) - the oblivious ones - while
// removeNO() deliberately calls the non-oblivious remove3 (kept around for
// tests/debugging that want to bypass ORAM obliviousness), and remove() goes
// through removeX, the oblivious delete path actually used at runtime.
#include "BTreeOMAP.h"
#include "Enclave.h"
#include "Enclave_t.h"
