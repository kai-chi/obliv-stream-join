// Path-ORAM mechanics: RandomPath/GetNodeOnPath/FetchPath/EvictBuckets/
// WriteBucket. See the class comment in BTreeORAM.hpp for the shape of the
// scheme; this file is the usual Path-ORAM implementation and doesn't have
// much specific to OBLIWIND beyond the node (de)serialization glue.
