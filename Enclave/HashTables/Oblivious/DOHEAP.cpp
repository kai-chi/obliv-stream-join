// Path Oblivious Heap implementation - see the class comment in DOHEAP.hpp.
// Structurally this mirrors BTreeORAM (path fetch, stash, eviction) but the
// tree holds heap-ordered nodes instead of B-Tree nodes, and buckets track a
// subtree-min so FindMin is a cheap root read instead of a path scan.
#include "DOHEAP.hpp"
#include <algorithm>
#include <iomanip>
#include <fstream>
